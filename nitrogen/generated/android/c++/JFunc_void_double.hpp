...
namespace margelo::nitro::PharmaScannerCxx {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/PharmaScanner/Func_void_double;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/PharmaScanner/Func_void_double_cxx;";
