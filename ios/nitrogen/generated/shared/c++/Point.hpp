...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::PharmaScannerCxx::Point> final {
    static inline margelo::nitro::PharmaScannerCxx::Point fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::PharmaScannerCxx::Point(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::PharmaScannerCxx::Point& arg) {
