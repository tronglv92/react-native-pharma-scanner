...
namespace margelo::nitro::PharmaScannerCxx {
  ...
  /**
   * A struct which can be represented as a JavaScript object (FrameRect).
   */
  struct FrameRect final {
  public:
  ...
  public:
    FrameRect() = default;
    explicit FrameRect(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const FrameRect& lhs, const FrameRect& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ FrameRect <> JS FrameRect (object)
  template <>
  struct JSIConverter<margelo::nitro::PharmaScannerCxx::FrameRect> final {
    static inline margelo::nitro::PharmaScannerCxx::FrameRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::PharmaScannerCxx::FrameRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::PharmaScannerCxx::FrameRect& arg) {
